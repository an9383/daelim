...
<div class="app pda_mo_wrap" style="display: flex;flex-direction: column;height: 100%;">
	<header class="pda_mo_hd">
		<a href="<c:url value="tmsc0190"/>" class="float-left"><img class="p-2" src="/resources/assets/images/mo_home_wh.png"></a> <a href="/tmsc0060"><p class="mo_main_title">제품입고</p></a>
	</header>
	<!--====-sortbox-->
...
<script>
	...
	$(document).attr("title","제품입고 승인처리");
	let menuAuth = 'tmsc0180';
