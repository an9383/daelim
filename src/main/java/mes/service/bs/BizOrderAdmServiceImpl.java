...
public class BizOrderAdmServiceImpl implements BizOrderAdmService {
	...
	public List<BizOrderAdmVo> approveProcList(BizOrderAdmVo bizOrderAdmVo) throws Exception{
		return dao.approveProcList(bizOrderAdmVo);
	}
}
