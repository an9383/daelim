...
<div class="app pda_mo_wrap" style="display: flex;flex-direction: column;height: 100%;">
	<header class="pda_mo_hd">
		<a href="/tmsc0100" class="float-left"><img class="p-2" src="/resources/assets/images/mo_home_wh.png"></a> <a href="/tmsc0300"><p class="mo_main_title">선입선출 조회</p></a>
	</header>
	<div class="pt-0">
		<button type="button" class="btn btn_item_gubun" id="item_006" onclick="gubunSelect('006')" style="height: 40px;width:49%;background: #F7C46C;color: black;border: 1px solid black;font-size: 15px;">원자재</button>
		<button type="button" class="btn btn_item_gubun" id="item_007" onclick="gubunSelect('007')" style="height: 40px;width:50%;background: #F3DFBB;color: black;border: 1px solid black;font-size: 15px;">제품</button>
	</div>
	<!--====-sortbox-->
						...
						<thead class="thead-light">
							<tr>
								<th style="min-width: 60px">
									<span class="label-date" id="label_006">입고일자</span>
									<span class="label-date d-none" id="label_007">생산일자</span>
								</th>
...
<script>
			...
			if(check==true){
			 	$.ajax({
	                ...
	                data: {
	                	...
	                	'locationNm' :  function(){return locationNm},
	                	'mainGubun'  : function(){return '002'}
	                },
    ...
    function gubunSelect(gubun){
		...
		locationCd = gubun;
		locationNm = locationCd=="006"?"원자재":"제품";
		$('#barcodeNo').focus();
		$('#barcodeNo').select();
