...
<div class="page-wrapper" id="page-wrapper">
	<div class="container-fluid" id="main">
		<div class="row table-wrap-hid">
			<!--======================== .left-list ========================-->
			<div class="left-list" id="left-list" style="width: 60%;">
				<img src="/resources/assets/images/logo/main_daerim_bg2.svg" style="position: absolute; top: 0; left: 0; width:100%; height: 100%;" alt="대림오토 메인 사진"/>
			</div>
			<div  class="right-list" id="right-list" style="width: 39%;">
				<!-- #main============================================================== -->
	<div class="container-fluid" id="main" style="width: 100%; height: 100%;">
		<div class="row bssListColumn">
			<!--======================== .left-list ========================-->
			<div class="" id="left-list" style="width: 100%;">
				<div class="card">
					...
					<div class="table-responsive">
						<div class="row bssListColumn_w">
							<span class="bbs_font_bold">공지사항</span>
							<span class="bbs_icon_plus">
								<a href="/cmsc0010" style="color: inherit;">+</a>
							</span>
						</div>
			...
			<!-- /.left-list -->
			<!--======================== .right-sidebar 등록,수정 ========================-->
			<div class="right-sidebar" id="myrSidenav"
				style="width: 100%;">
				<!--end----상단 버튼 part-->
				<!--====================TAB-UI=======================-->
					...
					<div id="myTabContent" class="tab-content">
						...
						<div class="tab-pane fade active show" id="tab1">
							...
							<div class="card-body col-sm-12 p-1">
								<span class="bbs_font_bold">공지사항 상세 보기</span>
							...
							<form id="form" method="post" enctype="multipart/form-data">
								...
								<div class="form-group m-0 mt-2">
									<input type="text" class="form-control-auto mb-3 bbsTitle_name"
										placeholder="제목" name="bbsTitle" id="bbsTitle" disabled/>
								</div>

								<!--텍스트-->
								<textarea class="textarea_box" name="bbsContent" id="bbsContent"  disabled style="min-height: 180px; padding-left: 0.5rem;"></textarea>
								
								
								<!--첨부파일1-->
								<div class="form-group m-0 mr-2 mt-2 row p-0 d-none disabled" id="fl01">
								...
								<div class="form-group" id="tf01" >
									...
									<div class="custom-file mt-2 d-none">
										<input type="file" class="custom-file-input" id="tf1" name="tf1" value="" disabled/>
...
<%@include file="../layout/bottom.jsp"%>
			...
			.DataTable(
					{
						...
						columns : [
						    	{	
						    		...
						    		data : 'bbsTitle',
						    		render: function(data, type, row, meta) {
										return data + '<span class="bbsTitle_circle d-none"><span class="bbsTitle_text">N</span></span>'
									},
									'className' : 'text-left',
						    	},
								{
	...
	//테이블 색 변경 
 	function imageChange(){
		$('#bbsListTable tbody tr').each(function(index, item) {
			var data = bbsListTable.row(index).data(); 
			//var regDate = bbsListTable.row['regDate'];
			var regDate = data.regDate;
			console.log("data.regDate" + regDate); 
			//시간 계산
			
			var serverDateNm = parseInt(year.toString() + mon.toString() + date.toString());
			var serverDateBeforeNm = parseInt(((regDate).substr(0,10)).replace(/-/g,''));
			var serverDateRes = serverDateNm - serverDateBeforeNm;
			console.log("serverDateRes  " + serverDateRes);

			if(serverDateRes <= 7){
				$(this).find('td:nth-child(2) > span').removeClass('d-none');
				console.log("완료!");
			}
		});
	} 
