	...
	<header class="page-title-bar row">
		<nav aria-label="breadcrumb" class="breadcrumb-padding">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">기간별 비가동현황</li>
			</ol>
		</nav>
	</header>
	<!-- #main============================================================== -->
						...
						<table id="workStatusTable" class="table table-bordered m-0 tr_highlight_row">
							<thead class="thead-light">
								<tr>
									...
									<th rowspan='2' class="text-center align-middle">비가동시간(합)/분</th>
									<th rowspan='2' class="text-center align-middle">비가동일자</th>
									<th rowspan='2' class="text-center align-middle">비가동구분</th>
									...
									<th rowspan='2' class="text-center align-middle">비가동시간/분</th>
								</tr>
								<tr>
