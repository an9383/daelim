		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content" style="width: 1200px; height: 800px; position: absolute; left: 50%; transform: translateX(-50%);">
	      		<div class="modal-header">
	        		<h5 class="modal-title" id="equipRestartPopUpLabel">금형등급 평가서 조회</h5>
	...
	<div class="modal fade bd-example-modal-lg" id="corrDataPopUpModal" tabindex="-1" role="dialog" aria-labelledby="corrDataPopUpModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-lg">
	    	<div class="modal-content" style="width: 1000px; position: absolute; left: 50%; transform: translateX(-50%);">
		        ...
		        <div class="modal-body">
		        	<label class="float-left" id="equipNmLabel" style="font-size: 20px;">금형명</label>
	...
	<header class="page-title-bar row">
		<nav aria-label="breadcrumb" class="breadcrumb-padding">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">금형관리대장</li>
			</ol>
		</nav>
	</header>
	<!-- #main============================================================== -->
...
<%-- 								<col width="6%"> --%>
							...
							<thead class="thead-light">
								<tr>
									<th rowspan="2" style="vertical-align: middle;">금형관리번호</th>
									<th rowspan="2" style="vertical-align: middle;">차종</th>
									<th rowspan="2" style="vertical-align: middle;">품번</th>
									<th rowspan="2" style="vertical-align: middle;">품명</th>
									...
									<th colspan="12">금형 점검 계획대비 실적 현황</th>
...
<script>
	...
	let menuAuth = 'mlsc0040';
	let currentHref = "mlsc0040";
	let currentPage = $('.' + currentHref).attr('id');
	$('#' + currentPage).closest('.has-child', 'li').addClass(
			'has-open has-active');
	$('#' + currentPage).closest('.menu-item').addClass('has-active');
	$(document).attr("title","금형관리대장"); 
...
// 		}, 
	...
	$('#equipCodeTable tbody').on('dblclick','tr',function() {
		...
		window.location.href = "mlsc0050?equipCd=" + equipCd;
	});
	...
	html1 += '</select>&nbsp;&nbsp;&nbsp;';
	html1 += '<button type="button" class="btn btn-primary" id="fileReferenceBtn" onclick="fileReferenceClick();">금형등급 평가서</button>';
