...
<div class="app pda_mo_wrap" style="display: flex;flex-direction: column;height: 100%;">
	<header class="pda_mo_hd">
		<a href="<c:url value="/tmsc0100"/>" class="float-left"><img class="p-2" src="/resources/assets/images/mo_home_wh.png"></a> <a href="/tmsc0310"><p class="mo_main_title">출하요청</p></a>
	</header>
	<!--====-sortbox-->
		...
		if (e.which == 13) {
	        ...
	        if (check) {
	        	$('#my-spinner').show(function(){
					...
					$.ajax({
		            	url: '<c:url value="po/pdaLotNoScanByBongjae"/>',
		                type: 'GET',
	    	...
	    	if ( lotNoPopupTable == null || lotNoPopupTable == undefined ) {
				lotNoPopupTable = $('#lotNoPopupTable').DataTable({
					...
					ajax : {
						...
						type : 'GET',
						data : {
							'mainGubun' : function(){ return '002'; }, //봉제
