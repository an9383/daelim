	...
	<header class="page-title-bar row">
		<nav aria-label="breadcrumb" class="breadcrumb-padding">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">매출 대비 자재입고현황</li>
			</ol>
		</nav>
	</header>
	<!-- #main============================================================== -->
						...
						<div class="table-responsive">
							<table id="salesRatioTable" class="table table-bordered m-0">
								...
								<thead class="thead-light">
									<tr>
										<th style="text-align:center !important">월</th>
										<th style="text-align:center !important">매출금액</th>
										<th style="text-align:center !important">자재입고금액</th>
										<th style="text-align:center !important">비율</th>
									</tr>
								</thead>
								<tfoot>
									<tr>
...
<script>
	...
	let currentHref = "bssc0210";
	let currentPage = $('.' + currentHref).attr('id');

	$('#' + currentPage).closest('.has-child', 'li').addClass('has-open has-active');
	$('#' + currentPage).closest('.menu-item').addClass('has-active');
	$(document).attr("title","매출 대비 자재입고현황"); 
