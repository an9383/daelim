		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content" style="width: 1200px; height: 800px; position: absolute; left: 50%; transform: translateX(-50%);">
	      		<div class="modal-header">
	        		<h5 class="modal-title" id="equipRestartPopUpLabel">철형 일상관리 절차서 조회</h5>
	...
	<div class="modal fade bd-example-modal-lg" id="equipPopUpModal3" tabindex="-1" role="dialog" aria-labelledby="equipPopUpModalLabel3" aria-hidden="true">
	  <div class="modal-dialog modal-lg">
	    <div class="modal-content">
		      <div class="modal-header">
		        <h5 class="modal-title" id="equipPopUpLabel3">철형코드조회</h5>
		        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
		          <span aria-hidden="true">&times;</span>
		        </button>
		      </div> 
	...
	<header class="page-title-bar row">
		<nav aria-label="breadcrumb" class="breadcrumb-padding">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">철형수리교체점검이력</li>
			</ol>
		</nav>
	</header>
	<!-- #main============================================================== -->
						...
						<div id="myTabContent" class="tab-content">
											...
											<tr>
												...
												<td>
													<div class="form-group input-sub m-0 row">
														<input class="form-control" type="date" id="troubleDate" name="troubleDate" disabled/>
													</div>
												</td>
											</tr>
											<tr>
							...
							<div class="tab-pane fade" id="tab2">
								<div class="card-body col-sm-12 p-1 mb-1">
									<button type="button" class="btn btn-primary d-none float-right mr-1" id="btnAttachSave">저장</button>
...
<script>
	...
	let currentHref = "mlsc0130";
	let currentPage = $('.' + currentHref).attr('id');

	$('#' + currentPage).closest('.has-child', 'li').addClass(
			'has-open has-active');
	$('#' + currentPage).closest('.menu-item').addClass('has-active');
	$(document).attr("title", "철형수리교체점검이력");
...
// 		sideView = 'add';
	...
	html += '<button type="button" class="btn btn-primary" id="fileReferenceBtn" onclick="fileReferenceClick();">철형 일상관리 절차서</button>';
	html += '</div>';
