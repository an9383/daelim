	...
	<header class="page-title-bar row">
		<nav aria-label="breadcrumb" class="breadcrumb-padding">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">투입LOT현황</li>
			</ol>
		</nav>
	</header>
	<!-- #main============================================================== -->
...
<script>
	...
	$(document).attr("title","투입LOT현황");
	 
	let workOrdNoVal = '';

	// 자재투입내역 테이블
	let workOrderMatrlTable = $('#workOrderMatrlTable')
			.DataTable(
					{
	...
	// 생산진행내역 테이블
	let workOrderTable = $('#workOrderTable')
			.DataTable(
					{
						dom : "<'row'<'col-sm-12 col-md-8'l><'col-sm-12 col-md-4'f>>"
								+ "<'row'<'col-sm-12 p-0'tr>>"
