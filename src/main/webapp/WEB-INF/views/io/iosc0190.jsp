...
<div class="page-wrapper" id="page-wrapper">
	...
	<header class="page-title-bar row">
		<nav aria-label="breadcrumb" class="breadcrumb-padding">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">개별발주(사출)</li>
			</ol>
		</nav>
	</header>
	<!-- #main============================================================== -->
	<div class="container-fluid" id="main">
              ...
              <div class="card top_sortbox p-2">
                ...
                <!-- 품목구분 -->
                  <label class="input-label-md ml-1">품목구분</label>
                  <div class="">
                   <div class="form-group-150">
						...
						<form id="form2" enctype="multipart/form-data">
							<div class="table-responsive">
								<table class="table table-bordered" id="purchaseOrderDtlTable">
									...
									<thead class="thead-light">
										<tr>
											<th><input type="checkbox" class="" id="btnAllCheck2"></th>
											<th>차종</th>
											<th>품번</th>
											<th>품명</th>
											<th>포장수량</th>
...
<script>
	...
	//공통코드 처리 시작	
	var itemGubunCode = new Array(); //구분
	...
	var mainGubunCode = new Array(); //구분
	...
	//선택박스 처리
	selectBoxAppend(itemGubunCode, "itemGubun", "004", ""); 
	...
	$('#itemGubun').on('change', function() {
		itemGubun =  $('#itemGubun :selected').val();
		$('#itemInfoAdmTable').DataTable().ajax.reload( function () {});
    });	
